...
def main(argv=None):
    ...
    p = sub.add_parser("import", help="convert an existing .it into a song file (samples extracted as WAVs)")
    p.add_argument("module")
    ...
    p.add_argument("--port", type=int, default=0, help="listen port (default: any free port)")
